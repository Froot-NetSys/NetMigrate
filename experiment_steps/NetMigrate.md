...
make clean && make
```
In our testbed, SRC_THRESHOLD_CLIENT can be set as around 30000 for NetMigrate-medium, and around 13000 for NetMigrate-short, for Figure 4~6, (d), (e); and 300000 or more for NetMigrate-long.
